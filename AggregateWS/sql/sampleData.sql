...
INSERT INTO `slices` VALUES ('maxpl_xi_test1', 1, 'http://geni.maxgigapop.net', 'Planetlab Slice#1 for MAX-GENI demo at GEC7', '', 'urn:ogf:geni:domain=dragon.maxgigapop.net:node=PLANETLAB2,urn:ogf:geni:domain=dragon.maxgigapop.net:node=PLANETLAB3,urn:ogf:geni:domain=dragon.maxgigapop.net:node=PLANETLAB4,urn:ogf:geni:domain=dragon.maxgigapop.net:node=PLANETLAB5', 100, UNIX_TIMESTAMP('2010-03-09 16:14:53'), UNIX_TIMESTAMP('2010-04-18 00:14:54'));
INSERT INTO `slices` VALUES ('maxpl_xi_test2', 2, 'http://geni.maxgigapop.net', 'Planetlab Slice#2 for MAX-GENI demo at GEC7', '', 'urn:ogf:geni:domain=dragon.maxgigapop.net:node=PLANETLAB3,urn:ogf:geni:domain=dragon.maxgigapop.net:node=PLANETLAB4,urn:ogf:geni:domain=dragon.maxgigapop.net:node=PLANETLAB5', 100, UNIX_TIMESTAMP('2010-03-10 01:49:32'), UNIX_TIMESTAMP('2010-04-18 17:49:33'));

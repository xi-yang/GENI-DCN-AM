 ...
 */
            ...
            /**
            *  QuerySliceNetworkType bean class
            */
        
        public  class QuerySliceNetworkType
        implements org.apache.axis2.databinding.ADBBean{
        /* This type was generated from the piece of schema that had
                name = QuerySliceNetworkType
   ...
   public static boolean isReaderMTOMAware(javax.xml.stream.XMLStreamReader reader) {
       ...
       public org.apache.axiom.om.OMElement getOMElement (
               ...
               org.apache.axiom.om.OMDataSource dataSource =
                 ...
                 public void serialize(org.apache.axis2.databinding.utils.writer.MTOMAwareXMLStreamWriter xmlWriter) throws javax.xml.stream.XMLStreamException {
                       QuerySliceNetworkType.this.serialize(parentQName,factory,xmlWriter);
                 }
               };
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":QuerySliceNetworkType",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "QuerySliceNetworkType",
                           xmlWriter);
                   }
    ...
    public static class Factory{
        ...
        */
        public static QuerySliceNetworkType parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            QuerySliceNetworkType object =
                new QuerySliceNetworkType();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"QuerySliceNetworkType".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (QuerySliceNetworkType)net.geni.aggregate.services.api.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }

...
/**
 * VlanReservationResultType.java
 *
 ...
 */
            ...
            /**
            *  VlanReservationResultType bean class
            */
        
        public  class VlanReservationResultType
        implements org.apache.axis2.databinding.ADBBean{
        /* This type was generated from the piece of schema that had
                name = VlanReservationResultType
        ...
        private static java.lang.String generatePrefix(java.lang.String namespace) {
            ...
            return org.apache.axis2.databinding.utils.BeanUtil.getUniquePrefix();
                        ...
                        */
                                    ...
                                    protected net.geni.aggregate.services.api.VlanReservationDescriptorType localReservation ;
                           ...
                           */
                           public  net.geni.aggregate.services.api.VlanReservationDescriptorType getReservation(){
                            ...
                            /**
                               ...
                               */
                               public void setReservation(net.geni.aggregate.services.api.VlanReservationDescriptorType param){
   ...
   public static boolean isReaderMTOMAware(javax.xml.stream.XMLStreamReader reader) {
       ...
       public org.apache.axiom.om.OMElement getOMElement (
               ...
               org.apache.axiom.om.OMDataSource dataSource =
                 ...
                 public void serialize(org.apache.axis2.databinding.utils.writer.MTOMAwareXMLStreamWriter xmlWriter) throws javax.xml.stream.XMLStreamException {
                       VlanReservationResultType.this.serialize(parentQName,factory,xmlWriter);
                 }
               };
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":VlanReservationResultType",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "VlanReservationResultType",
                           xmlWriter);
                   }
                                           ...
                                           localReservation.serialize(new javax.xml.namespace.QName("http://aggregate.geni.net/services/api/","reservation"),
                                               factory,xmlWriter);
    ...
    public static class Factory{
        ...
        */
        public static VlanReservationResultType parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            VlanReservationResultType object =
                new VlanReservationResultType();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"VlanReservationResultType".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (VlanReservationResultType)net.geni.aggregate.services.api.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://aggregate.geni.net/services/api/","reservation").equals(reader.getName())){
                                
                                                object.setReservation(net.geni.aggregate.services.api.VlanReservationDescriptorType.Factory.parse(reader));
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://aggregate.geni.net/services/api/","globalReservationId").equals(reader.getName())){

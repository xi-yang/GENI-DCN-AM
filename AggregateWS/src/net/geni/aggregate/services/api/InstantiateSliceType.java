 ...
 */
            ...
            /**
            *  InstantiateSliceType bean class
            */
        

        public  class InstantiateSliceType
        implements org.apache.axis2.databinding.ADBBean{
        /* This type was generated from the piece of schema that had
                name = InstantiateSliceType
                        ...
                        */
                           ...
                           */
                           public  java.lang.String[] getNodeID(){
                              ...
                              /**
                               * validate the array for NodeID
                               */
                              protected void validateNodeID(java.lang.String[] param){
                             ...
                             */
                             public void addNodeID(java.lang.String param){
                                   if (localNodeID == null){
                                   localNodeID = new java.lang.String[]{};
                                   }

                            

                               java.util.List list =
                            org.apache.axis2.databinding.utils.ConverterUtil.toList(localNodeID);
                               list.add(param);
                               this.localNodeID =
   ...
   public static boolean isReaderMTOMAware(javax.xml.stream.XMLStreamReader reader) {
       ...
       public org.apache.axiom.om.OMElement getOMElement (
               ...
               org.apache.axiom.om.OMDataSource dataSource =
                 ...
                 public void serialize(org.apache.axis2.databinding.utils.writer.MTOMAwareXMLStreamWriter xmlWriter) throws javax.xml.stream.XMLStreamException {
                       InstantiateSliceType.this.serialize(parentQName,factory,xmlWriter);
                 }
               };
                    ...
                    if (namespace != null) {
                        ...
                        xmlWriter.writeStartElement(parentQName.getLocalPart());
                             ...
                             if (localNodeID!=null) {
                                   ...
                                   for (int i = 0;i < localNodeID.length;i++){
                                        
                                            if (localNodeID[i] != null){
                                        
                                                if (!emptyNamespace) {
                                                    if (prefix == null) {
                                                        java.lang.String prefix2 = generatePrefix(namespace);

                                                        xmlWriter.writeStartElement(prefix2,"nodeID", namespace);
                                                    ...
                                                    xmlWriter.writeStartElement("nodeID");
                                                        ...
                                                        xmlWriter.writeCharacters(localNodeID[i]);
                                  ...
                                  for (int i = 0;i < localNodeID.length;i++){
                                         ...
                                         if (localNodeID[i] != null){
                                          elementList.add(new javax.xml.namespace.QName("http://aggregate.geni.net/services/api/",
                                                                              "nodeID"));
                                          elementList.add(
                                          org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localNodeID[i]));
                                          } else {
    ...
    public static class Factory{
        ...
        */
        public static InstantiateSliceType parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            InstantiateSliceType object =
                new InstantiateSliceType();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"InstantiateSliceType".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (InstantiateSliceType)net.geni.aggregate.services.api.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                        ...
                        java.util.ArrayList list1 = new java.util.ArrayList();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://aggregate.geni.net/services/api/","nodeID").equals(reader.getName())){
                                    ...
                                    list1.add(reader.getElementText());
                                            ...
                                            while(!loopDone1){
                                                ...
                                                if (reader.isEndElement()){
                                                    ...
                                                    if (new javax.xml.namespace.QName("http://aggregate.geni.net/services/api/","nodeID").equals(reader.getName())){
                                                         list1.add(reader.getElementText());
                                            ...
                                            // call the converter utility  to convert and set the array
                                                    ...
                                                    object.setNodeID((java.lang.String[])
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://aggregate.geni.net/services/api/","start").equals(reader.getName())){
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://aggregate.geni.net/services/api/","end").equals(reader.getName())){

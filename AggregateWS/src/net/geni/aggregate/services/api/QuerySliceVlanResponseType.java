...
/**
 * QuerySliceVlanResponseType.java
 *
 ...
 */
            ...
            /**
            *  QuerySliceVlanResponseType bean class
            */
        
        public  class QuerySliceVlanResponseType
        implements org.apache.axis2.databinding.ADBBean{
        /* This type was generated from the piece of schema that had
                name = QuerySliceVlanResponseType
   ...
   public static boolean isReaderMTOMAware(javax.xml.stream.XMLStreamReader reader) {
       ...
       public org.apache.axiom.om.OMElement getOMElement (
               ...
               org.apache.axiom.om.OMDataSource dataSource =
                 ...
                 public void serialize(org.apache.axis2.databinding.utils.writer.MTOMAwareXMLStreamWriter xmlWriter) throws javax.xml.stream.XMLStreamException {
                       QuerySliceVlanResponseType.this.serialize(parentQName,factory,xmlWriter);
                 }
               };
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":QuerySliceVlanResponseType",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "QuerySliceVlanResponseType",
                           xmlWriter);
                   }
                                           ...
                                           localVlanResvResult.serialize(new javax.xml.namespace.QName("http://aggregate.geni.net/services/api/","vlanResvResult"),
                                               factory,xmlWriter);
        ...
        public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
                 ...
                 java.util.ArrayList attribList = new java.util.ArrayList();
                            ...
                            elementList.add(new javax.xml.namespace.QName("http://aggregate.geni.net/services/api/",
                                    ...
                                    elementList.add(localVlanResvResult);
    ...
    public static class Factory{
        ...
        */
        public static QuerySliceVlanResponseType parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            QuerySliceVlanResponseType object =
                new QuerySliceVlanResponseType();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"QuerySliceVlanResponseType".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (QuerySliceVlanResponseType)net.geni.aggregate.services.api.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://aggregate.geni.net/services/api/","vlanResvResult").equals(reader.getName())){
                                                ...
                                                object.setVlanResvResult(net.geni.aggregate.services.api.VlanReservationResultType.Factory.parse(reader));
